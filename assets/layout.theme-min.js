function debounce(t, e, n) {
  ...
  return function () {
    var a = this,
      ...
      u = n && !i;
    clearTimeout(i), (i = setTimeout(o, e)), u && t.apply(a, r);
  };
}
!(function (t) {
  function e(e) {
    for (
      var i, o, u = e[0], s = e[1], c = e[2], d = 0, f = [];
      d < u.length;
      d++
    )
      (o = u[d]), a[o] && f.push(a[o][0]), (a[o] = 0);
  ...
  function n() {
    for (var t, e = 0; e < r.length; e++) {
      for (var n = r[e], i = !0, u = 1; u < n.length; u++) {
        var s = n[u];
        0 !== a[s] && (i = !1);
      }
  ...
  function (t, e, n) {
    ...
    e.default = {
      components: { SwellMessage: a.default },
      mounted: function () {},
      methods: {
      ...
      computed: Object.assign(
        ...
        (0, i.mapState)({
          customer: function (t) {
            return t.cart[o.default.SWELL_CUSTOMER.stateKey];
          },
          isSubmitting: function (t) {
            return t.cart[o.default.SWELL_DISCOUNT_CODE.loadingKey];
          },
          redemptionOptions: function (t) {
            var e = t.cart[o.default.SWELL_REDEMPTION_OPTIONS.stateKey],
              n = t.cart[o.default.SWELL_CUSTOMER.stateKey].pointsBalance;
            return e.length
              ? e.filter(function (t) {
          ...
          availableCredit: function (t) {
            var e = t.cart[o.default.SWELL_CUSTOMER.stateKey].pointsBalance;
    ...
    var i = function () {
        ...
        return n(
          "div",
          {
            ...
            class: { "opacity-50 pointer-events-none": t.isSubmitting },
          },
          [
            n("SwellMessage", [
            ...
            t._v(" "),
            n("div", { staticClass: "row my-4" }, [
              n("div", { staticClass: "col w-1/2" }, [
                n(
                  "select",
                  {
                  ...
                  t._l(t.redemptionOptions, function (e) {
                    return n(
                      "option",
                      { key: "opt-" + e.id, domProps: { value: e.id } },
                      [
                        t._v(
                          "\n          " +
              ...
              n("div", { staticClass: "col w-1/2" }, [
                n(
                  "button",
                  {
                    ...
                    attrs: { type: "button", disabled: t.isSubmitting },
                    on: {
                      click: function (e) {
  ...
  function (t, e, n) {
    ...
    n(149);
    var o = n(0),
      u = Object(o.a)(a.default, i.a, i.b, !0, null, null, null);
    e.default = u.exports;
  },
  ,
  ,
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      ...
      (e.default = {
        ...
        props: {
          ...
          openOverride: { type: Boolean, default: !1 },
        },
        mounted: function () {
  ...
  function (t, e, n) {
    ...
    e.default = {
      ...
      methods: Object.assign({}, (0, o.mapActions)(["addLineItem"]), {
        setup: function () {
    ...
    e.default = {
      ...
      mounted: function () {
        ...
        window.PubSub.subscribe("cart:opened", function (e) {
          t.$nextTick(function () {
            (0, l.disableBodyScroll)(document.querySelector(".cart-outer"));
          });
        }),
          window.PubSub.subscribe("cart:closed", l.clearAllBodyScrollLocks);
      },
      computed: Object.assign(
        {
          loginUrl: function () {
      ...
      methods: Object.assign({}, (0, c.mapActions)(["closeCart"]), {
          ...
          if ((t.target, document.body.classList.contains("template-cart")))
            ...
            var o =
              this.$store.state.cart[d.default.SWELL_DISCOUNT_CODE.stateKey]
                .code;
            o && (o = "&discount=" + o);
            var u = this.$refs.cartForm.querySelector(
              '[name="attributes[sitedomain]"]'
            );
            u && (r = "&shopdomain=" + u.value);
            var s = "";
            if (window.convert) {
              var c = window.convert.getCookie("_conv_v"),
                l = window.convert.getCookie("_conv_s");
              c && (s += "&_conv_v=" + encodeURIComponent(c)),
                l && (s += "&_conv_s=" + encodeURIComponent(l));
            }
            window.location =
  ...
  function (t, e, n) {
    ...
    var i = n(10),
      a = (n(260), n(11));
    e.default = {
      props: { remaining: Number, hasSubscriptionItems: Boolean },
      computed: Object.assign(
        {
          barWidth: function () {
            return { width: 25 * (1 - this.remaining) + "%" };
          },
          itemType: function () {
            var t = "item";
            return (
  ...
  function (t, e, n) {
    ...
    e.default = {
      components: {
        ...
        PointsRedemptionForm: o.default,
      },
      data: function () {
      ...
      computed: Object.assign(
        ...
        (0, i.mapState)({
          discount: function (t) {
            return t.cart[u.default.SWELL_DISCOUNT_CODE.stateKey].code;
          },
          discountType: function (t) {
            return t.cart[u.default.SWELL_DISCOUNT_CODE.stateKey].type;
          },
        }),
  ...
  function (t, e, n) {
    ...
    e.default = {
      components: { CartSubtotalRow: r.default, CartDiscounts: o.default },
      computed: Object.assign(
        {},
        (0, i.mapState)({
          subtotal: function (t) {
          ...
          total: function (t) {
            ...
            return (
              t.cart[u.default.SWELL_DISCOUNT_CODE.stateKey].amount &&
                (e -= t.cart[u.default.SWELL_DISCOUNT_CODE.stateKey].amount),
              (0, a.formatMoney)(e)
            );
          },
          discountAmount: function (t) {
            return t.cart[u.default.SWELL_DISCOUNT_CODE.stateKey].amount || 1e3;
          },
  ...
  function (t, e, n) {
    ...
    e.default = {
      props: {
        code: String,
        amount: { required: !0, type: [Number, String], default: 1e3 },
      },
      components: { CartSubtotalRow: i.default },
      computed: {
  ...
  function (t, e, n) {
    ...
    e.default = {
      ...
      components: { NumberField: i.default },
      computed: {
  ...
  function (t, e, n) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 });
    var i = n(352);
    e.default = { components: { ContentLoader: i.ContentLoader } };
  },
  function (t, e, n) {},
  function (t, e, n) {
    "use strict";
  ...
  function (t, e, n) {
    ...
    e.default = {
      data: function () {
        return { items: [], menu: [], heading: "" };
      },
      props: {
        title: { type: Number, required: !0 },
        location: { type: String, required: !0 },
        options: { type: String, required: !1, default: "" },
      },
      mounted: function () {
                  ...
                  [
                    t.items.length
                      ? n(
                          ...
                          t._l(t.items, function (e) {
                            return n("NavItem", {
                              key: "item-" + e.ID,
                              attrs: { item: e, "data-item-id": e.ID },
                              scopedSlots: t._u(
                                [
                                  {
                                    key: "after",
                    ...
                    n(
                      ...
                      [
                        ...
                        t._v(" "),
                        n("div", { staticClass: "col w-full sm:w-1" }, [
                          n(
                            "div",
                            {
                              staticClass: "super-header-widgets mt-6 sm:mt-0",
                            },
                            [
                              n("div", {
                                domProps: { innerHTML: t._s(t.widgetContents) },
                              }),
                            ]
                          ),
                        ]),
  ...
  function (t, e, n) {
    ...
    var i = function () {
        var t = this,
          e = t.$createElement,
          n = t._self._c || e;
        return n("div", { staticClass: "navigation" }, [
          t.menu.name
            ? n("div", {
                staticClass:
                  "navigation__heading text-2xl md:text-3xl font-bold pb-4 md:pb-6",
                domProps: { innerHTML: t._s(t.menu.name) },
              })
            : t._e(),
          t._v(" "),
          t.items.length > 0
            ? n(
                ...
                t._l(t.items, function (e) {
                  return n("li", { key: e.ID, staticClass: "mb-1" }, [
                    n("a", {
                      staticClass:
                        "block py-2 font-light hover:underline focus:underline",
                      attrs: { href: e.url, title: e.title, target: e.target },
        ...
        return t.items.length
          ? n(
              "ul",
              {
                ...
                attrs: { id: "menu-social-navigation" },
              },
              t._l(t.items, function (e) {
                return n(
                  "li",
                  ...
                  [
                    n(
                      ...
                      t._l(t.icons, function (i, a) {
                        return n("div", { key: i.index }, [
                          a == e.title
                            ? n("div", { domProps: { innerHTML: t._s(i) } })
                            : t._e(),
                        ]);
                      }),
                      0
    ...
    var i = function () {
        ...
        return n(
          "form",
          {
            ...
            attrs: { method: "get", id: "searchform", action: t.action },
          },
          [
            n("label", { staticClass: "sr-only", attrs: { for: "s" } }, [
              t._v("Search"),
            ]),
            t._v(" "),
            n("div", { staticClass: "relative" }, [
              n("input", {
                attrs: { type: "hidden", name: "post_type", value: "any" },
              }),
              t._v(" "),
              n("input", {
                directives: [
              ...
              n(
                "button",
                {
                  ...
                  attrs: { type: "submit", id: "searchsubmit" },
                },
                [
                  n(
                    "svg",
                  ...
                  t._v(" "),
                  n("span", { staticClass: "sr-only" }, [t._v("Search>")]),
                ]
              ),
            ]),
          ]
            ...
            t._t(
              ...
              [
                n(
                  ...
                  [
                    n("span", { domProps: { innerHTML: t._s(t.item.title) } }),
                    t._v(" "),
                    n("span", { staticClass: "" }, [
                      n(
                        "svg",
        ...
        return this.visible
          ? e(
              "div",
              {
                ...
                on: { click: this.closeCart },
              },
              [e("div", { staticClass: "w-full h-full bg-black opacity-50" })]
            )
          : this._e();
      },
      a = [];
    ...
    var i = function () {
          ...
          [
            n(
              "form",
              {
                ...
                attrs: { action: "/checkout", method: "post", novalidate: "" },
                on: {
                  submit: function (e) {
                ...
                n(
                  ...
                  [
                    n(
                      ...
                      [
                        ...
                        t.itemCount
                          ...
                          : t._e(),
                        t._v(" "),
                        n("CloseButton", { staticClass: "-mr-2" }),
                      ],
                      1
                    ),
                    t._v(" "),
                    t.items && t.items.length
                      ...
                      : 0 == t.items.length
                      ? n("h3", { staticClass: "text-center text-2xl my-8" }, [
                          t._v("\n        Your Cart is Empty!\n      "),
                        ])
                      : t._e(),
                    t._v(" "),
      ...
      a = [
        function () {
          var t = this.$createElement,
            e = this._self._c || t;
          return e("div", { staticClass: "text-center pb-6" }, [e("a", {})]);
        },
      ];
    n.d(e, "a", function () {
      return i;
  ...
  function (t, e, n) {
    ...
    var i = function () {
        ...
        return n(
          ...
          [
            n("div", { staticClass: "flex-1 w-full" }, [
              Number.isNaN(t.remaining) || t.remaining
                ? n("div", [
                    n("div", {
                      staticClass:
                        "font-medium text-sm sm:text-base mb-2 leading-tight",
                      class: { "mt-2": 1 == t.remaining },
                      domProps: { innerHTML: t._s(t.remainingMessage) },
                    }),
                    t._v(" "),
                    t.remaining < 1
                      ? n(
              ...
              t.remaining
                ? t._e()
                : n("div", { staticClass: "font-bold leading-tight" }, [
                    t.subtotal < 7500
                      ? n("div", [
                          t._v(
                            "You’re " +
      ...
      a = [
        function () {
          var t = this.$createElement,
            e = this._self._c || t;
          return e("div", { staticClass: "text-sm font-normal" }, [
            this._v("\n          Total must be $75+ "),
  ...
  function (t, e, n) {
    ...
    var i = function () {
        ...
        return n(
          ...
          [
            n("CartSubtotalRow", {
              attrs: { label: "Subtotal", value: t.subtotal },
            }),
            t._v(" "),
            n("CartSubtotalRow", {
              attrs: { label: "Estimated shipping", value: "FREE" },
            }),
            t._v(" "),
            t.discountCode
              ? n("CartDiscounts", {
                  attrs: { code: t.discountCode, amount: t.discountAmount },
                })
              : t._e(),
            t._v(" "),
            n(
                      ...
                      fn: function () {
                        return [
                          n("div", {
                            ...
                            domProps: { textContent: t._s(t.total) },
                          }),
                        ];
                      },
                      proxy: !0,
  ...
  function (t, e, n) {
    ...
    var i = function () {
        ...
        return n(
          ...
          [
            n("span", { staticClass: "close-btn__icon-bar block bg-current" }),
            t._v(" "),
            n("span", { staticClass: "close-btn__icon-bar block bg-current" }),
          ]
        );
  ...
  function (t, e, n) {
    ...
    var i = function () {
        var t = this,
          e = t.$createElement,
          n = t._self._c || e;
        return n("div", { staticClass: "py-4 relative" }, [
          n("div", { staticClass: "row" }, [
            n("div", { staticClass: "col w-1/3" }, [
              t.image
                ? n(
                    "div",
                    {
                      ...
                      attrs: { "data-bgset": t.image },
                    },
                    [n("div", { staticClass: "pt-full" })]
                  )
                : t._e(),
            ]),
            t._v(" "),
            n(
              ...
              [
                n("p", { staticClass: "h4 text-lg mb-0" }, [
                  n(
                    "a",
                    {
                      staticClass: "inline-block no-underline leading-tight",
                      attrs: { title: t.product_title, href: t.productUrl },
                    },
                    [
                      n("strong", {
                        domProps: { innerHTML: t._s(t.renderedTitle) },
                      }),
                    ]
                  ),
                ]),
                ...
                t._v(" "),
                t.isSubscriptionItem
                  ? n("p", { staticClass: "text-black text-base mb-0" }, [
                      t._v(
                        "\n        Delivered every " +
                  ...
                  : t._e(),
                t._v(" "),
                n("div", { staticClass: "sr-only" }, [t._v("Price")]),
                t._v(" "),
                n("div", { staticClass: "text-base text-black mt-2" }, [
                ...
                n("input", {
                  ...
                  domProps: { value: t.itemQuantity },
                  on: {
                    input: function (e) {
                      e.target.composing || (t.itemQuantity = e.target.value);
                    },
                  },
                }),
              ]
          ...
          t._v(" "),
          n("div", { staticClass: "row justify-between mt-4" }, [
            n(
              "div",
              { staticClass: "col w-auto" },
              [
                n("div", { staticClass: "sr-only" }, [t._v("Quantity")]),
                t._v(" "),
                n("number-field", {
  ...
  function (t, e, n) {
    ...
    var i = function () {
        ...
        return n(
          ...
          [
            n("div", { staticClass: "block w-full flex-1" }, [
              n(
                "div",
                ...
                [
                  n(
                    ...
                    [
                      n("rect", { attrs: { width: "38", height: "38" } }),
                      t._v(" "),
                      n("rect", {
                        attrs: { x: "44", width: "253", height: "13" },
                      }),
                      t._v(" "),
                      n("rect", {
                        attrs: { x: "44", y: "16", width: "154", height: "13" },
                      }),
                      t._v(" "),
                      n("rect", {
                        attrs: { x: "44", y: "37", width: "154", height: "13" },
                      }),
                      t._v(" "),
                      n("rect", {
                        attrs: { x: "44", y: "81", width: "94", height: "31" },
                      }),
                    ]
                  ),
                ],
              ...
              n(
                ...
                [
                  n(
                    ...
                    [
                      n("rect", { attrs: { width: "64", height: "64" } }),
                      t._v(" "),
                      n("rect", {
                        attrs: { x: "72", y: "2", width: "311", height: "17" },
                      }),
                      t._v(" "),
                      n("rect", {
                        attrs: { x: "72", y: "21", width: "76", height: "17" },
                      }),
                      t._v(" "),
                      n("rect", {
                        attrs: { x: "72", y: "40", width: "95", height: "17" },
                      }),
                      t._v(" "),
                      n("rect", {
                        attrs: { x: "72", y: "66", width: "95", height: "32" },
                      }),
                    ]
                  ),
                ],
  ...
  function (t, e, n) {
    ...
    var i = function (t, e) {
        ...
        return n(
          ...
          [
            e._t("label", [
              n("div", { staticClass: "text-left" }, [
                e._v(e._s(e.props.label)),
              ]),
            ]),
            e._v(" "),
            e._t("value", [
              n("div", { staticClass: "text-right" }, [
  ...
  function (t, e, n) {
    ...
    var i = function () {
        var t = this,
          e = t.$createElement,
          n = t._self._c || e;
        return n("div", { staticClass: "number-field relative inline-block" }, [
          n(
            "button",
            {
              staticClass:
              ...
              attrs: { type: "button", "aria-label": "Decrease Number" },
              on: {
                click: function (e) {
                  e.preventDefault(),
          ...
          n("input", {
            ...
            attrs: { type: "number", name: "updates[]" },
    ...
    (0, i.register)("header", {
        ...
        (this.header = this.container.querySelector("[data-header-nav]")),
          ...
          this.header &&
            (a.default.use(r.default, {
              breakpoints: { sm: 768, md: 992, lg: 1140, xl: 1 / 0 },
            }),
            new a.default({
              render: function (t) {
                return t(o.default);
      ...
      events: function () {
        ...
        window.PubSub.subscribe("header:nav:toggle", function (e, n) {
          n.open, t.navWrapper.classList.toggle(c);
        }),
          window.PubSub.subscribe("header:nav:close", function () {
            t.navWrapper.classList.remove(c);
          }),
          window.PubSub.subscribe("header:nav:reset", function () {
            t.navWrapper.classList.remove(c);
          });
      ...
      toggle: function (t) {
        t.target.closest(s) &&
          ...
          window.PubSub.publish("header:nav:toggle", { open: this.navOpen })),
          replaceShopToOrder();
      },
      cartIcon: function (t) {
      ...
      (0, a.register)("slide-out-cart", {
        ...
        setupSlideoutCart: function () {
          new window.Vue({
            ...
            $(document).on("swell:setup", function () {
              window.store.commit(u.default.SWELL_CUSTOMER.SUCCESS, {
                customer: swellAPI.getCustomerDetails(),
              }),
                window.store.commit(
                  u.default.SWELL_REDEMPTION_OPTIONS.SUCCESS,
        ...
        handleUpdate: function (t, e) {
          var n = this,
            i = e.field,
            a = { quantity: e.quantity, id: i.dataset.variantId };
          fetch("/cart/change.js", {
            ...
            .then(function (t) {
              ...
              o.formatMoney)(a)),
                ...
                ).innerText = (0, o.formatMoney)(i)),
                e.forEach(function (t) {
                  n.container.querySelector(
                    (function (t) {
                      return '[data-line-item-total="' + t + '"]';
                    })(t.variant_id)
                  ).innerText = (0, o.formatMoney)(t.final_line_price);
                }),
        ...
        updateCartIconsCount: function (t) {
          document
            ...
            .forEach(function (e) {
              return (
                t > 0
                  ? $("[data-header-cart-count]").removeClass(
                      "cart_zero_hidden"
                    )
                  : $("[data-header-cart-count]").addClass("cart_zero_hidden"),
                (e.innerText = t)
  ...
  function (t, e, n) {
    ...
    var o = new i.default.Store({ modules: { cart: a.default } });
    e.default = o;
  },
  function (t, e, n) {
    "use strict";
    ...
    var p =
        ((i = { open: !1, itemsData: { items: [] }, loggedIn: !1 }),
      ...
      m = {
        addLineItem: function (t, e) {
          t.commit("addPlaceholder"),
            (0, u.default)(
              t,
              {
                url: (0, l.getenv)("shopify.urls.cartAdd"),
                method: "post",
                dataType: "jsonp",
                data: e,
              },
        ...
        getItemsAsync: function (t) {
          (0, u.default)(
            t,
            { url: (0, l.getenv)("shopify.urls.cart"), dataType: "jsonp" },
        ...
        quantityChanged: function (t, e) {
          (0, u.default)(
            ...
            window.PubSub.publish("cart:updated", { cart: t.state.itemsData });
            var i = (0, c.default)(t.state.itemsData.items, function (t) {
          ...
          new Promise(function (n, i) {
            t.commit(s.default.SWELL_DISCOUNT_CODE.PENDING),
              swellAPI.makeRedemption(
                Object.assign({}, e, { delayPointDeduction: !0 }),
                n,
                i
              );
          })
      ...
      v =
        ((a = {
          closeCart: function (t) {
            o.default.set(t, "open", !1);
          },
          openCart: function (t) {
            o.default.set(t, "open", !0);
          },
          addPlaceholder: function (t) {
            var e = t[s.default.ITEMS.stateKey],
              n = e.items;
            n.unshift({ placeholder: !0 }),
              (e = Object.assign({}, e, n)),
              o.default.set(t, "" + s.default.ITEMS.stateKey, e);
          },
          setLoggedIn: function (t, e) {
            o.default.set(t, "loggedIn", e);
          },
        }),
        (0, r.default)(a, s.default.ITEMS.SUCCESS, function (t, e) {
          o.default.set(t, s.default.ITEMS.loadingKey, !1),
            o.default.set(t, s.default.ADD_ITEM.loadingKey, !1),
            o.default.set(t, s.default.ITEMS.stateKey, e);
        }),
        (0, r.default)(a, s.default.ITEMS.PENDING, function (t) {
          o.default.set(t, s.default.ITEMS.loadingKey, !0);
        }),
        (0, r.default)(a, s.default.ADD_ITEM.SUCCESS, function (t, e) {
          ...
          var a = Object.assign({}, t[s.default.ITEMS.stateKey], { items: n }),
            r = a.items.reduce(function (t, e) {
              return t + e.final_line_price;
            }, 0);
          (a.items_subtotal_price = r),
            o.default.set(t, "" + s.default.ITEMS.stateKey, a),
            o.default.set(t, "open", !0),
        ...
        (0, r.default)(a, s.default.ADD_ITEM.PENDING, function (t) {
          o.default.set(t, s.default.ADD_ITEM.loadingKey, !0);
        }),
        ...
        (0, r.default)(a, s.default.SWELL_REDEMPTION.SUCCESS, function (t, e) {
          o.default.set(t, s.default.SWELL_REDEMPTION.stateKey, e);
        }),
        ...
        (0, r.default)(
          ...
          function (t, e) {
            o.default.set(t, s.default.SWELL_DISCOUNT_CODE.stateKey, e),
              o.default.set(t, s.default.SWELL_DISCOUNT_CODE.loadingKey, !1);
          }
        ),
        (0, r.default)(a, s.default.SWELL_DISCOUNT_CODE.PENDING, function (t) {
          o.default.set(t, s.default.SWELL_DISCOUNT_CODE.loadingKey, !0);
        }),
        (0, r.default)(a, "removeDiscountCode", function (t) {
          o.default.set(t, s.default.SWELL_DISCOUNT_CODE.stateKey, {});
        }),
        a),
      h = {
    ...
    e.default = { state: p, actions: m, mutations: v, getters: h };
  },
  ,
  ,
  ,
      ...
      (e.default = function (t, e, n) {
        ...
        return (
          ...
          $.ajax(e)
            ...
            .fail(function (e, n) {
              return t.commit(i.FAILURE, e), { error: e, status: n };
            })
        );
      });
  },
  ...
  function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 }), (e.getenv = void 0);
    var i = (function (t) {
        return t && t.__esModule ? t : { default: t };
      })(n(71)),
      a = {
        ...
        wordpress: { url: "https://www.katefarms.com" },
      };
    (e.default = a),
      (e.getenv = function (t) {
  ...
  function (t, e, n) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      document.addEventListener("DOMContentLoaded", function () {
        window.PubSub.publish("window:scroll", { top: u.scrollTop() }),
...
var replaceShopToOrder = debounce(function () {
  [...document.querySelectorAll(".nav-item--depth-1")].forEach((t) => {
    t.querySelector("span");
    t.querySelector("a").classList.remove("nav-item__link--transparent");
  });
}, 700);
function resourceAccordion() {
  var t = { body: $("body"), ddl_link: $(".accordion-container > a") };
  $(t.ddl_link).each(function () {
...
replaceShopToOrder(),
  ...
  $(window).on("load", function () {
    $(".accordion-container").length > 0 &&
      $(".accordion-container").each(function (t) {
        var e = "." + $(this).attr("targetForJS");
        console.log(e), new Accordion(e);
      });
  }),
  $(".nav-toggle").on("click", function () {
    $(".main-navigation").toggleClass("visible-on-mobile");
  });
